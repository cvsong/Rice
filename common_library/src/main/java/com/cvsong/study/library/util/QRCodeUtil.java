...
import com.cvsong.study.library.util.utilcode.util.SizeUtils;
...
//   hints.put(EncodeHintType.MARGIN, 2); //default is 4
     ...
     * @throws Exception
     */
    public static Bitmap createBarCode(String str, Integer mwidth, Integer mheight) throws Exception {
        MultiFormatWriter writer = new MultiFormatWriter();
        Hashtable<EncodeHintType, String> hst = new Hashtable<EncodeHintType, String>();
        hst.put(EncodeHintType.CHARACTER_SET, "UTF-8");
        BitMatrix matrix = writer.encode(str, BarcodeFormat.CODE_128, SizeUtils.dp2px(mwidth), SizeUtils.dp2px(mheight), hst);
