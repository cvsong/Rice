...
public class StickyScrollView extends ScrollView {
    ...
    private void startStickingView(View viewThatShouldStick) {
        if (visiableChangeListener != null) {
            visiableChangeListener.onVisiableChanged(true);
        }
    ...
    private void stopStickingCurrentlyStickingView() {
        if (visiableChangeListener != null) {
            visiableChangeListener.onVisiableChanged(false);
        }
        if (getStringTagForView(currentlyStickingView).contains(FLAG_HASTRANSPARANCY)) {
            showView(currentlyStickingView);
        }
    ...
    private OnStickViewVisiableChangeListener visiableChangeListener;

    /**
     * 悬停View显隐回调,仅针对单个View悬停
     */
    public interface OnStickViewVisiableChangeListener {
        void onVisiableChanged(boolean visiable);

    }

    public void setVisiableChangeListener(OnStickViewVisiableChangeListener visiableChangeListener) {
        this.visiableChangeListener = visiableChangeListener;
    }
