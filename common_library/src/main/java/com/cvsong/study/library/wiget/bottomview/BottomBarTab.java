package com.cvsong.study.library.wiget.bottomview;
...
public class BottomBarTab extends FrameLayout {
    ...
    private int unselectIcon;//未选中时的图标
    private int selectedIcon;//选中时图标

    public BottomBarTab(Context context, @DrawableRes int unselectIcon, int selectedIcon, CharSequence title) {
        this(context, null, unselectIcon, selectedIcon, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int unselectIcon, int selectedIcon, CharSequence title) {
        this(context, attrs, 0, unselectIcon, selectedIcon, title);
    }

    public BottomBarTab(Context context, AttributeSet attrs, int defStyleAttr, int unselectIcon, int selectedIcon, CharSequence title) {
        super(context, attrs, defStyleAttr);
        init(context, unselectIcon, selectedIcon, title);
    }

    private void init(Context context, int unselectIcon, int selectedIcon, CharSequence title) {
...
//        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.tab_unselect));//设置颜色过滤
        ...
        mTvTitle.setTextSize(TypedValue.COMPLEX_UNIT_SP,10);
